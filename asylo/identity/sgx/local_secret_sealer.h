...
/// enclave's identity. In either mode, the sealed secret is bound to all bits
/// of MISCSELECT, and all security-sensitive bits of ATTRIBUTES, as defined in
/// secs_attributes.h.
///
...
class LocalSecretSealer : public SecretSealer {
 public:
  /// Creates a LocalSecretSealer that seals secrets to the MRENCLAVE part of
  /// the enclave code identity.
  ///
