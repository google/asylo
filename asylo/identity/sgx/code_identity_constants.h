...
#ifndef ASYLO_IDENTITY_SGX_CODE_IDENTITY_CONSTANTS_H_
#define ASYLO_IDENTITY_SGX_CODE_IDENTITY_CONSTANTS_H_
...
#endif  // ASYLO_IDENTITY_SGX_CODE_IDENTITY_CONSTANTS_H_
