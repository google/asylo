...
#ifndef ASYLO_IDENTITY_ATTESTATION_SGX_INTERNAL_ENCLAVE_DCAP_LIBRARY_INTERFACE_H_
#define ASYLO_IDENTITY_ATTESTATION_SGX_INTERNAL_ENCLAVE_DCAP_LIBRARY_INTERFACE_H_
...
// Implements the DcapLibraryInterface as OCALLs which exit a currently running
// enclave in order to call the DCAP library. This generates quotes via calls
// originating inside an enclave.
class EnclaveDcapLibraryInterface : public DcapLibraryInterface {
 public:
...
#endif  // ASYLO_IDENTITY_ATTESTATION_SGX_INTERNAL_ENCLAVE_DCAP_LIBRARY_INTERFACE_H_
