...
def asylo_testonly_deps():
    ...
    if not native.existing_rule("com_google_googletest"):
        http_archive(
            ...
            # Commit from 2019 September 16
            urls = [
                "https://github.com/google/googletest/archive/f2fb48c3b3d79a75a88a99fba6576b25d42ec528.tar.gz",
            ],
...
def asylo_deps(toolchain_path = None):
    ...
    if not native.existing_rule("boringssl"):
        http_archive(
            ...
            # Commit from 2019 September 16
            urls = [
                "https://github.com/google/boringssl/archive/abf6024432ec93afceac2bdcd60690a6c786a3d8.tar.gz",
            ],
            sha256 = "5a724734814d9977a28ec422e5b03da17108cb41745058f544d97ca461fef4ed",
            strip_prefix = "boringssl-abf6024432ec93afceac2bdcd60690a6c786a3d8",
        )
    ...
    if not native.existing_rule("com_google_absl"):
        http_archive(
            ...
            # Commit from 2019 September 12
            urls = [
                "https://github.com/abseil/abseil-cpp/archive/ac78ffc3bc0a8b295cab9a03817760fd460df2a1.tar.gz",
            ],
            sha256 = "5c009c1ebdf2f86afef7775314437989ddcd823c6c57a1efc56e0f9bd11baaa3",
...
def asylo_go_deps():
    ...
    if not native.existing_rule("io_bazel_rules_go"):
        http_archive(
            ...
            urls = ["https://github.com/bazelbuild/rules_go/archive/v0.19.5.tar.gz"],
            sha256 = "513c12397db1bc9aa46dd62f02dd94b49a9b5d17444d49b5a04c5a89f3053c1c",
            strip_prefix = "rules_go-v0.19.5",
        )
