...
def asylo_testonly_deps():
    ...
    if not native.existing_rule("com_google_googletest"):
        http_archive(
            ...
            urls = [
                "https://github.com/google/googletest/archive/93748a946684defd1494d5585dbc912e451e83f8.tar.gz",
            ],
            sha256 = "1f41e1a0ffc93171d0bbd5f5777f4bc3ce56dd8a9f577ede2b88aaa7e027e263",
...
def asylo_deps(toolchain_path = None):
    ...
    if not native.existing_rule("com_google_absl"):
        http_archive(
            ...
            # Commit from 2020 December 03
            urls = [
                "https://github.com/abseil/abseil-cpp/archive/acf3390ca28edf1438fa896602ffede2a7dff103.tar.gz",
            ],
            sha256 = "d705eaf2c6c1d9edd16faa2da8a7670fadb1aa937dad785ca063a7a0215d6ce8",
...
""",
    ...
    if not native.existing_rule("com_github_curl_curl"):
        http_archive(
            ...
            urls = [
                "https://github.com/curl/curl/archive/curl-7_73_0.tar.gz",
            ],
            sha256 = "552e401e9de5e35c67cddd130da5dcf0455caa1b42fe7ad044efc9c0de822ef6",
            strip_prefix = "curl-curl-7_73_0",
...
def asylo_go_deps():
    ...
    if not native.existing_rule("io_bazel_rules_go"):
        http_archive(
            ...
            urls = ["https://github.com/bazelbuild/rules_go/archive/v0.24.8.tar.gz"],
            sha256 = "145db04a1821945f00038b144acc032d5f0f66984babf2c8fcb096f9dcf63be4",
            strip_prefix = "rules_go-0.24.8",
        )
...
""",
            # Commit from 2020 August 20
            urls = ["https://github.com/golang/crypto/archive/5c72a883971a4325f8c62bf07b6d38c20ea47a6a.tar.gz"],
            sha256 = "18930a558f50afe676706959b59363c9355d8f1e9b9ac7ba8d887ff372092cd3",
            strip_prefix = "crypto-5c72a883971a4325f8c62bf07b6d38c20ea47a6a",
        )
