...
def asylo_deps(toolchain_path = None):
    ...
    if not native.existing_rule("boringssl"):
        http_archive(
            ...
            urls = [
                "https://github.com/google/boringssl/archive/9f73b80dd14ebceccd23772d210dfb68f1f9c5be.tar.gz",
            ],
            sha256 = "035ca8f187636952837fae8ac8f29ab5234b0d9d7b865a3d1db931bd74914e61",
            strip_prefix = "boringssl-9f73b80dd14ebceccd23772d210dfb68f1f9c5be",
        )
    ...
    if not native.existing_rule("com_google_absl"):
        http_archive(
            ...
            # Commit from 2020 April 22
            urls = [
                "https://github.com/abseil/abseil-cpp/archive/68494aae959dfbbf781cdf03a988d2f5fc7e4802.tar.gz",
            ],
            sha256 = "b8f50b031244eba7a68c7e5af306bfb26045f00b4fe7114d4f762544c2b4afde",
...
""",
            # Commit from 2020 April 14
            urls = ["https://github.com/golang/crypto/archive/0848c9571904fcbcb24543358ca8b5a7dbfde875.tar.gz"],
            sha256 = "861fd3e7d9752459a57b18454122b2b0b86b86c577919c8944e9894a905b864f",
            strip_prefix = "crypto-0848c9571904fcbcb24543358ca8b5a7dbfde875",
        )
