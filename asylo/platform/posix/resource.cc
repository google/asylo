...
#ifndef THIRD_PARTY_ASYLO_PLATFORM_POSIX_RESOURCE_CC_
#define THIRD_PARTY_ASYLO_PLATFORM_POSIX_RESOURCE_CC_
...
#endif  // THIRD_PARTY_ASYLO_PLATFORM_POSIX_RESOURCE_CC_
