...
#ifndef ASYLO_PLATFORM_CORE_UNTRUSTED_CACHE_MALLOC_H_
#define ASYLO_PLATFORM_CORE_UNTRUSTED_CACHE_MALLOC_H_
...
#endif  // ASYLO_PLATFORM_CORE_UNTRUSTED_CACHE_MALLOC_H_
