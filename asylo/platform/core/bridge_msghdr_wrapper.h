...
#ifndef ASYLO_PLATFORM_CORE_BRIDGE_MSGHDR_WRAPPER_H_
#define ASYLO_PLATFORM_CORE_BRIDGE_MSGHDR_WRAPPER_H_
...
#endif  // ASYLO_PLATFORM_CORE_BRIDGE_MSGHDR_WRAPPER_H_
